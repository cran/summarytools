...
This document uses theme `rmarkdown::html_vignette`. Its **yaml** section 
looks like this:
...
you could find that other settings yield better results. Also, this document
focuses on _HTML_ document rendering. If you are looking to create a _Word_ of a 
_pdf_ document, you might want to try different combinations of options.

One thing that seems clear though: the _rendering_ method is **not** well-suited
for _Word_ documents.